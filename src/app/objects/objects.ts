...
export const WHO_WE_ARE = {
  ...
  image: 'assets/about/who_we_are.png'
}
...
export const OUR_MISSION = {
  ...
  image: 'assets/about/our_mission.png'
}

export const HOW_CAN_WE_HELP_YOU = {
  ...
  image: 'assets/about/how_can_we_help.png'
}

export const NAVIGATION_BAR_ELEMENTS = [
  {
    name: 'about',
    label: 'ABOUT',
  },
...
export const PRODUCT_SOLUTIONS = [
  {
    ...
    icon: 'assets/product-solutions/ingredients.png',
  ...
  },
  {
    ...
    icon: 'assets/product-solutions/formulations.png',
  ...
  },
  {
    ...
    icon: 'assets/product-solutions/manufacturing.png',
  ...
  },
  {
    ...
    icon: 'assets/product-solutions/packaging.png',
...
export const REGULATORY_COMPLIANCE = [
  {
    ...
    icon: 'assets/regulatory-compliance/canada.png'
  },
  {
    header: {
      name: 'usa_compliance',
    ...
    icon: 'assets/regulatory-compliance/america.png'
  },
  {
    header: {
    ...
    icon: 'assets/regulatory-compliance/map.png'
  }
]
...
export const CONTACT_US_MESSAGE = '<b>Have a question?</b><br /><br /> We’re here to help! Our friendly and knowledgeable customer experience team love feedbacks from you! Feel free to reach us via phone, email or the form below.'

export const FAQ_ELEMENTS: any[] = [
  {
    index: 1,
...
export const MAINTENANCE_TITLE = "Offline for maintenance";

export const MAINTENANCE_SUBTITLE = "We are currently undergoing\nscheduled maintenance.\n\nPlease check back later.";
